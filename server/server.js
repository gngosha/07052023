...
app.post('/', async (req, res) => {
  try {
    ...
    let prompt = `Ты должен загадать страну ${country} и описать её. Название страны - секрет. В своём ответе ты должен сделать следующее: Не говори названия страны ${country}; Скажи на каком контененте находится, размер, ИЧР(индекс человеческого развития), ВВП, что чаще всего импортирует/экспортирует, Не говори названия страны, какие запасы нефти, газа, топлива, древесины; состоит ли в международных организациях по типу ООН, АТЭС и т.д. Не говори названия страны, Упомяни географические особенности, если такие есть.`;
