...
app.post('/', async (req, res) => {
  try {
    ...
    let prompt = `Ты должен загадать страну ${country} и описать её. Название страны - секрет. В своём ответе ты должен сделать следующее: Не говори названия страны ${country}; Скажи на каком контененте находится, размер (в точных цифрах), 
